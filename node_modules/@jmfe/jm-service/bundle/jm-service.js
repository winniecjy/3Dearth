(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@jmfe/jm-common'), require('@jmfe/jm-cookie')) :
    typeof define === 'function' && define.amd ? define(['exports', '@jmfe/jm-common', '@jmfe/jm-cookie'], factory) :
    (factory((global.jm = global.jm || {}, global.jm.service = global.jm.service || {}),global.jm.common,global.jm.cookie));
}(this, (function (exports,_jmfe_jmCommon,cookie) { 'use strict';
...
function jsonp(url, params, opts) {
	...
	url = url + '?' + _jmfe_jmCommon.serialize(params);
...
ajax.get = function (url, params, opts) {
	url = url + '?' + _jmfe_jmCommon.serialize(params);
	var options = _jmfe_jmCommon.assign({
		method: 'GET',
		credentials: 'include'
	}, opts);
...
var uuid = _jmfe_jmCommon.getUUID() || cookie.get('mba_muid') || '';
...
function getAdvGroups(ids) {
	...
	if (_jmfe_jmCommon.isArray(ids)) ids = ids.join(',');
	...
	if (data.length) {
		...
		var params = _jmfe_jmCommon.assign({
...
function getBookingInfo(activityId, skuIds) {
	if (_jmfe_jmCommon.isArray(skuIds)) {
		skuIds = skuIds.join(',');
	}
	var params = _jmfe_jmCommon.assign({
...
function getDiscoveryInventoryList(page, lastId) {
	...
	var params = _jmfe_jmCommon.assign({
		...
		uuid: _jmfe_jmCommon.getUUID() || cookie.get('mba_muid') || ''
	}, clientParams);
	return jsonp(apiBase, params);
}
...
function getRankCates(options) {
	...
	var settings = _jmfe_jmCommon.assign(defaults, options);
	var params = _jmfe_jmCommon.assign({
		functionId: "rankList",
...
exports.getAdvGroups = getAdvGroups;
exports.getProductGroups = getProductGroups;
exports.getProductGroupsCurStage = getProductGroupsCurStage;
exports.getProductGroupStage = getProductGroupStage;
exports.getProductGroupStages = getProductGroupStages;
exports.makeAppointment = makeAppointment;
exports.booking = booking;
exports.getBookingInfo = getBookingInfo;
exports.getLuckyDrawInfo = getLuckyDrawInfo;
exports.batchLuckyDrawStock = batchLuckyDrawStock;
exports.doLuckyDraw = doLuckyDraw;
exports.doLuckyDrawAsync = doLuckyDrawAsync;
exports.addToCart = addToCart;
exports.verifyNewUser = verifyNewUser;
exports.getShareInfo = getShareInfo;
exports.getDiscoveryInventoryList = getDiscoveryInventoryList;
exports.verifyPlusAndNewUser = verifyPlusAndNewUser;
exports.getRankCates = getRankCates;
exports.getRankParty = getRankParty;
exports.bICouponDraw = bICouponDraw;
exports.setCDNConf = setCDNConf;
exports.jsonp = jsonp;
exports.ajax = ajax;
